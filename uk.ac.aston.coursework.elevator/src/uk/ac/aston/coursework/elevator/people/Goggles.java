...
/**
 * This class represents Goggles which is a type of Developer.
 * 
 * @author Nisath
 *
 */
public class Goggles extends Developer {
	private static int IDCOUNT;

	/**
	 * Constructs Goggles with a unique ID to differentiate from other Goggles.
	 * 
	 * @param building    the {@code Building} object that this person should spawn
	 *                    in.
	 * @param probability the probability of the person changing floor in
	 *                    {@code double}.
	 * @param rnd         a {@code Random} object with a set seed.
	 */
	public Goggles(Building building, double probability, Random rnd) {
		super(building, rnd);
		ID = IDCOUNT + 1;
		IDCOUNT++;
	}
	...
	public String toString() {
		return ID + "D-G(T:" + getTargetFloor() + ")";
	}
}
